...
namespace DepoStokBitirmeProjesi.Controllers
{
    ...
    public class BinalarController : Controller
    {
        ...
        public BinalarController(DepoStokBitirmeProjesiContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Binalar != null ? 
                          ...
                          Problem("Entity set 'DepoStokBitirmeProjesiContext.Binalar'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,BinaAdi,Sehir")] Binalar binalar)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,BinaAdi,Sehir")] Binalar binalar)
        {
            if (id != binalar.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DepoStokBitirmeProjesiContext.Binalar'  is null.");
            }
            var binalar = await _context.Binalar.FindAsync(id);
            if (binalar != null)
            {
